...
{ "vanilla" 
	...
	{ "subwindows"  
		{ inlet outlet inlet~ outlet~ table pd }  
	}
	{ "data templates"  
...
{ "gem geometric" 
	{ "geometric 2D"
		{ square rectangle circle triangle sphere polygon trapazoid torus disk curve cuboid ripple mesh_square mesh_line } 
	}
	{ "geometric 3D"
		{ cube tube cylinder cone surface3d sphere3d curve3d pqtorusknots newWave } 
	}
	{ "particles"
		{ part_source part_draw part_killold part_head part_velocity part_color part_gravity part_size part_orbitpoint part_targetsize part_targetcolor part_render part_info part_sink } 
	}
} 