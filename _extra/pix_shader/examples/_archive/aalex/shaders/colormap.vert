...
void main()
{
	...
	texcoord4 = vec2(gl_TextureMatrix[4] * gl_MultiTexCoord0);
	texcoord5 = vec2(gl_TextureMatrix[5] * gl_MultiTexCoord0);
	texcoord6 = vec2(gl_TextureMatrix[6] * gl_MultiTexCoord0);
	texcoord7 = vec2(gl_TextureMatrix[7] * gl_MultiTexCoord0);
