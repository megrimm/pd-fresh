...
{ 	
	...
	vec4 input0 = texture2D(tex0,offset0 * texdim0);
	vec4 input1 = texture2D(tex0,offset1 * texdim0);
	vec4 input2 = texture2D(tex0,offset2 * texdim0);
	vec4 input3 = texture2D(tex0,offset3 * texdim0);
	vec4 input4 = texture2D(tex0,offset4 * texdim0);
	vec4 input5 = texture2D(tex0,offset5 * texdim0);
	vec4 input6 = texture2D(tex0,offset6 * texdim0);
	vec4 input7 = texture2D(tex0,offset7 * texdim0);
	vec4 input8 = texture2D(tex0,offset8 * texdim0);
